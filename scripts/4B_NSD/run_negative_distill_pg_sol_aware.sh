...
# Full MATH dataset (per-sample generated adversarial prompts)
# 8x A100 80GB GPUs | Qwen3-4B NON-THINKING (Instruct) mode
...
# Attack prompts generated by Qwen3-4B instruct (solution-aware prompt)
...
########################### launch ###########################
LOG_DIR="${SCRIPT_DIR}/logs_sigmoid_push_full_instruct_4bgen_sol_aware"
mkdir -p "${LOG_DIR}"
